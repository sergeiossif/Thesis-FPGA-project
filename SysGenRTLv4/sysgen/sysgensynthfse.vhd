...
entity sysgensynthfse_synth_lms_filter1 is
  port (
    i_in : in std_logic_vector( 12-1 downto 0 );
    q_in : in std_logic_vector( 12-1 downto 0 );
    err_i_x0 : in std_logic_vector( 18-1 downto 0 );
    err_q_x0 : in std_logic_vector( 18-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
    clk_4 : in std_logic;
    ce_4 : in std_logic;
...
begin
  ...
  up_sample_q_net <= err_i_x0;
  up_sample1_q_net <= err_q_x0;
  err_i <= sreg_q_net;
  err_q <= sreg1_q_net;
  clk_net_x0 <= clk_1;
  ce_net <= ce_1;
...
entity sysgensynthfse_filters is
  port (
    ...
    err_i : out std_logic_vector( 18-1 downto 0 );
    err_q_x0 : out std_logic_vector( 18-1 downto 0 )
  );
...
begin
  ...
  mcode_mu_e_i_net <= err_i_x0;
  mcode_mu_e_q_net <= err_q;
  err_i <= sreg_q_net;
  err_q_x0 <= sreg1_q_net;
  clk_net_x1 <= clk_1;
  ce_net_x1 <= ce_1;
  clk_net <= clk_2;
  ce_net <= ce_2;
  ...
  port map (
    ...
    err_i_x0 => up_sample_q_net,
    err_q_x0 => up_sample1_q_net,
    clk_1 => clk_net_x1,
    ce_1 => ce_net_x1,
    clk_4 => clk_net_x0,
    ce_4 => ce_net_x0,
