...
namespace eval ::xilinx::dsp::planaheaddriver {
	...
	set TargetDir {E:/Thesis/Thesis-FPGA-project/SysGenRTLv2}
	...
	dict set TopLevelPortInterface gateway_out Type Fix_18_10
	dict set TopLevelPortInterface gateway_out ArithmeticType xlSigned
	dict set TopLevelPortInterface gateway_out BinaryPoint 10
	dict set TopLevelPortInterface gateway_out Width 18
	dict set TopLevelPortInterface gateway_out DatFile {sysgensynthfse_t_2_fse_filters_synth_lms_filter1_gateway_out.dat}
	...
	dict set TopLevelPortInterface gateway_out ClockDomain {sysgensynthfse}
	...
	dict set TopLevelPortInterface gateway_out1 Type Fix_18_10
	dict set TopLevelPortInterface gateway_out1 ArithmeticType xlSigned
	dict set TopLevelPortInterface gateway_out1 BinaryPoint 10
	dict set TopLevelPortInterface gateway_out1 Width 18
	dict set TopLevelPortInterface gateway_out1 DatFile {sysgensynthfse_t_2_fse_filters_synth_lms_filter1_gateway_out1.dat}
	...
	dict set TopLevelPortInterface gateway_out1 ClockDomain {sysgensynthfse}
