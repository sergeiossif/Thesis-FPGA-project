...
namespace eval ::xilinx::dsp::planaheaddriver {
	...
	set TargetDir {E:/Thesis/Thesis-FPGA-project/SysGenRTLv5}
	...
	dict set TopLevelPortInterface coeff_i Name {coeff_i}
	dict set TopLevelPortInterface coeff_i Type Fix_18_10
	dict set TopLevelPortInterface coeff_i ArithmeticType xlSigned
	dict set TopLevelPortInterface coeff_i BinaryPoint 10
	dict set TopLevelPortInterface coeff_i Width 18
	dict set TopLevelPortInterface coeff_i DatFile {sysgensynthfse_t_2_fse_filters_synth_lms_filter1_coeff_i.dat}
	dict set TopLevelPortInterface coeff_i IconText {coeff_i}
	dict set TopLevelPortInterface coeff_i Direction out
	dict set TopLevelPortInterface coeff_i Period 1
	dict set TopLevelPortInterface coeff_i Interface 0
	dict set TopLevelPortInterface coeff_i InterfaceName {}
	dict set TopLevelPortInterface coeff_i InterfaceString {DATA}
	dict set TopLevelPortInterface coeff_i ClockDomain {sysgensynthfse}
	dict set TopLevelPortInterface coeff_i Locs {}
	dict set TopLevelPortInterface coeff_i IOStandard {}
	dict set TopLevelPortInterface coeff_q Name {coeff_q}
	dict set TopLevelPortInterface coeff_q Type Fix_18_10
	dict set TopLevelPortInterface coeff_q ArithmeticType xlSigned
	dict set TopLevelPortInterface coeff_q BinaryPoint 10
	dict set TopLevelPortInterface coeff_q Width 18
	dict set TopLevelPortInterface coeff_q DatFile {sysgensynthfse_t_2_fse_filters_synth_lms_filter1_coeff_q.dat}
	dict set TopLevelPortInterface coeff_q IconText {coeff_q}
	dict set TopLevelPortInterface coeff_q Direction out
	dict set TopLevelPortInterface coeff_q Period 1
	dict set TopLevelPortInterface coeff_q Interface 0
	dict set TopLevelPortInterface coeff_q InterfaceName {}
	dict set TopLevelPortInterface coeff_q InterfaceString {DATA}
	dict set TopLevelPortInterface coeff_q ClockDomain {sysgensynthfse}
	dict set TopLevelPortInterface coeff_q Locs {}
	dict set TopLevelPortInterface coeff_q IOStandard {}
